      ...
      <div className="flex flex-col gap-10 w-[80vw] md:w-max">
        ...
        <div className="grid grid-cols-2">
          ...
          >
            ...
            {hovered && (
              <div
                className="absolute h-32 w-32 inset-0 flex item-center justify-center bg-black/50 ring-fuchsia-50 rounded-full mt-14"
                onClick={image ? handleDeleteImage : handleFileInputClick}
              >
                {image ? (
                  <FaTrash className="text-white text-3xl cursor-pointer" />
                ) : (
                  <FaPlus className="text-white text-3xl mt-12 cursor-pointer" />
                )}
              </div>
            )}
            <input
